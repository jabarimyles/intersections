...
stu_data1 = pd.read_sas('C:/Users/jamyle/Documents/Traffic/geo_nc_intersections.sas7bdat')
stu_data2 = pd.read_sas('C:/Users/jamyle/Documents/Traffic/geo_nc_intersections_2019.sas7bdat')
...
def get_maps_image(site, NW_lat_long, SE_lat_long, zoom=18):
    ...
    for x in range(cols):
        for y in range(rows):
            ...
            final.save("//sso.vsp.sas.com/amd/Customers/NC_Department_of_Transportation_NDT/Solution_Development/Traffic/TerrainOtsuImages/Terrain_Otsu_" + str(int(site)) + ".png")
...
for site in sites:
        image1 = cv2.imread("//sso.vsp.sas.com/amd/Customers/NC_Department_of_Transportation_NDT/Solution_Development/Traffic/TerrainImages/Terrain_" + str(int(site)) + ".png")  
        ...
        im.save("//sso.vsp.sas.com/amd/Customers/NC_Department_of_Transportation_NDT/Solution_Development/Traffic/TerrainOtsuImages/Terrain_Otsu_" + str(int(site)) + ".png")
        print("Photo done!")
